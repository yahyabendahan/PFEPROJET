...
@Component
public class WriterSbfRejet extends JdbcBatchItemWriter<ImpayesCdlRejetModel>{

	//test
	
	
	    public WriterSbfRejet(DataSource dataSource) {
	    	...
	    	this.setSql("INSERT INTO IMPAYES_CDL_REJET (NATENG, TYPE, CPT, MONTANT_CREANCE, DATE_CREANCE, NO_DOSSIER, REFFERENCE_VALEUR, DATE_ECHEANCE, CODE_ETABLISST_BANCAIRE, CODE_GUICHET_BANCAIRE, DATE_REMISE, REFERNCE_LIAISON, CODE_REJET, COMISSION, DATE_REJET, MOTIF_REJET) " +
                "VALUES (:nateng, :type, :cpt, :montantCreance, :dateCreance, :noDossier, :refferenceValeur, :dateEcheance, :codeEtablissementBancaire, :codeGuichetBancaire, :dateRemise, :referenceLiaison, :codeRejet, :commission, :refferenceValeur, :dateRejet, :motifRejet)");
